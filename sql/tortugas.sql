...
CREATE TABLE `menus` (
  ...
  `nubes` int(11) DEFAULT NULL,
  `perros` int(11) DEFAULT NULL,
  `patos` int(11) DEFAULT NULL,
...
INSERT INTO `menus` VALUES (1,NULL,NULL,NULL,0,10,'landing','link','Landing Page','fas fa-rocket','/KumbiaSoft/index',_binary '\0','','','','',_binary '\0',0,'2020-05-16',_binary '\0',NULL,NULL,NULL),(2,NULL,NULL,NULL,0,20,'','header','Interfaces','','',_binary '\0','','','','',_binary '\0',0,'2020-05-16',_binary '',NULL,NULL,NULL),(3,NULL,NULL,NULL,0,30,'components','link','Components','oi oi-puzzle-piece','/KumbiaSoft/index',_binary '','','','','',_binary '\0',0,'2020-05-16',_binary '',NULL,NULL,NULL),(4,NULL,NULL,NULL,3,1,'general','link','General','','tables',_binary '\0','','','','',_binary '\0',0,'2020-05-16',_binary '',NULL,NULL,NULL);
...
-- Dump completed on 2020-05-19 17:40:55
